                        ...
                        <div class="user_info_block">
                            ...
                            <div class="p_relative">
                                <form action="">
                                    ...
                                    <button class="btn search_btn" onclick="window.location='{{route("music")}}'" type="button">Старт</button>
                                </form>
        ...
        <section class=" ">
            <div class="container">
                <div class="row mb_xl_15">
                    <div class="w75 w100_md mt_xl_50 mt_md_30 px_md_11">
                        <h1>Что такое сервис VKtoMP3?</h1>
                        <div class="">
