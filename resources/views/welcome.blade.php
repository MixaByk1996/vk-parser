...
<div class="wrapper">
    ...
    <main id="main">
        <section class="top_section p_relative">
            <div class="container row stretch wrap-items">
                <div class="bg_gray w60 w100_md intro_block_txt">
                    <h1>Как скачать музыку c ВК?</h1>
                    <div class="">
                        <p class="intro_txt">Для того чтобы скачать музыку из Вконтакте, необходимо пройти по ссылке:
                            <a class="d_block mb_xl_10 mb_md_3" href="https://vk.com/settings?act=privacy">https://vk.com/settings?act=privacy</a>
                            и указать в пункте <b>Кто видит мои аудиозаписи — Все пользователи.</b></p>
                        <picture>
                            <source srcset="img/screenVK-mobile-3x.png" media="(max-width: 941px)">
                            <img src="img/screenVK.png" alt="screenVK" class="mb_xl_10">
                        </picture>
                        <p>Либо зайдите в ваш <a href="https://vk.com">Вконтакте</a>, нажмите на вашу аватарку в правом верхнем углу, затем выберите в правом, появившемся меню, пункт <span class="bold">Приватность</span> и также разрешите Всем пользователям видеть ваш список аудиозаписей.</p>
                    </div>
                </div>
                <div class="w40 w100_md cat_bg"></div>
            </div>
        </section>

        <section class="about_section">
            <div class="about_block">
                <h2>Что такое сервис VKtoMP3?</h2>
                <p>Сервис VK to MP3 предназначен для того чтобы можно было скачать свою музыку, музыку вашего друга, или любого другого пользователя из Вконтакте в MP3 формате.</p>
                <p>Не нужно скачивать и устанавливать никаких сторонних приложений на ваше устройство, просто введите ссылку любого пользователя и нажмите найти. Но обязательным является условие, чтобы музыка в настройках приватности ВК была открыта для всех пользователей.</p>
                <p>Скачать музыку с ВК онлайн очень просто на компьютер, телефон, либо планшет.</p>
            </div>
        </section>
    </main>
    <footer class="footer mt_md_73">
        <div class="container row wrap-items row_justify_center_md">
            ...
            <div class="mr_xl_35 mr_sm_25">
                <a class="bold basic_txt" href="{{route('rules')}}">Правила</a>
            </div>
            <div class="">
                <svg width="21px" height="20px" viewBox="0 0 21 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">         <g id="02-Music-Desktop" transform="translate(-883.000000, -312.000000)" fill="#F5A623">             <g id="Header">                 <g id="LoginOpen">                     <g transform="translate(863.000000, 0.000000)">                         <g id="favorits" transform="translate(20.000000, 312.000000)">                             <polygon id="ico-favorits" points="10.5 15.4794167 4.01064312 19.9721868 6.27819991 12.4120994 -2.47718512e-15 7.62869654 7.89078405 7.4490757 10.5 0 13.1092159 7.4490757 21 7.62869654 14.7218001 12.4120994 16.9893569 19.9721868"></polygon>                         </g>                     </g>                 </g>             </g>         </g>     </g>
                </svg>
    ...
    <div class="hidden"><div id="play_list"></div></div>
</div>
